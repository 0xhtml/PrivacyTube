...
$system->mysql("create table if not exists videos( sql_id int auto_increment primary key, sql_date timestamp default CURRENT_TIMESTAMP, sql_state int, id varchar(11) unique, title text, description text, channel varchar(24), date timestamp null, thumbnail text)");
